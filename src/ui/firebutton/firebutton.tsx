...
const FireButton = () => {
  const originalImage = 'src/ui/firebutton/5d686d20ad5d533f.svg' // 元の画像のURL
  const newImage = 'src/ui/firebutton/74ded5ed6a42fc41.svg' // 新しい画像のURL
  ...
  return (
    <Button
      sx={{
        '&:hover': {
          // カーソルがボタンに合わされたときのスタイルを無効にする
          backgroundColor: 'transparent', // 背景を透明にする
        },
        '&:active': {
          // ボタンが押されたときのスタイルを無効にする
          backgroundColor: 'transparent', // 背景を透明にする
        },
      }}
